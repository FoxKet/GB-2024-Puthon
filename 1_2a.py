# сумма чисел из списка кубов нечетных чисел от 1 до 100 сумма цифр которых нацело делиться на 7
list_e = []
list_d = []
list_s = []
list_et = []
...
# создаем список из нечетных чисел от 1 до 1000
cube_list = [(i*2+1)**3 for i in range(500)]
print(cube_list)
